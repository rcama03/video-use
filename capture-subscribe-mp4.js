...
(async () => {
  ...
  // Add black background after clearRect inside draw()
  html = html.replace(
    '// transparent canvas each frame\n  g.clearRect(0,0,W,H);',
  ...
  execSync(
    `ffmpeg -y -framerate ${FPS} -i ${DIR}/f%05d.jpg -i /tmp/subscribe-audio-v2.wav ` +
